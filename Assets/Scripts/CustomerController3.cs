...
public class CustomerController3 : MonoBehaviour
{
    ...
    void Update()
    {
      ...
      if (this.delta > this.span)
      {
          ...
          Vector2 customer3 = transform.position; //客の位置を取得する
          order.transform.position = new Vector3(transform.position.x + 2.3f, transform.position.y, transform.position.z); //生成したプレハブを客の隣に配置する
